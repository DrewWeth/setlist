...
class SetListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create set_list" do
    assert_difference('SetList.count') do
      post set_lists_url, params: { set_list: { description: @set_list.description, gig_date: @set_list.gig_date, name: @set_list.name } }
    end
  ...
  test "should update set_list" do
    patch set_list_url(@set_list), params: { set_list: { description: @set_list.description, gig_date: @set_list.gig_date, name: @set_list.name } }
